...
export class FavoritesController {
  ...
  create(@Body() favoriteDto: FavoriteDto, @GetUser() user: User) {
    return this.favoritesService.create(favoriteDto, user);
  }
  ...
  @Delete()
  @Auth()
  remove(@Body() favoriteDto: FavoriteDto, @GetUser() user: User) {
    return this.favoritesService.remove(favoriteDto, user);
  }
}
